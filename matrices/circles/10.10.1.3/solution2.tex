...
\myvec{5&0}\vec{Q}&=5\\
\vec{Q}&=\myvec{5\\ \mu}\\
	\vec{Q}&=\myvec{5\\0}+\mu\myvec{0\\1}\label{eq:8}
\end{align}
		The \eqref{eq:8} can be expressed in the form of parametric equation
\begin{align}
	\vec{Q}=\vec{A}+\mu\vec{m}\label{eq:9}
\end{align}
		Then substituting \eqref{eq:9} in \eqref{eq:1} yeilds,
\begin{align}
...
\implies \norm{\vec{A}}^2+\mu^2\norm{\vec{m}}^2+2\mu\vec{A}^{\top}\vec{m}&=d^2\\
	\implies \mu^2\norm{\vec{m}}^2+2\mu\vec{A}^{\top}\vec{m}+\norm{\vec{A}}^2&=d^2\label{eq:13}
\end{align}
where
\begin{align}                                                                          \vec{A}=\myvec{5\\0}\text{ and }\vec{m}=\myvec{0\\1}
\end{align}
		substituting the values of $\vec{A}$ and $\vec{m}$ in \eqref{eq:13} gives
\begin{align}
\mu=\sqrt{119}
\end{align}
		substituting the value of $\mu$ in \eqref{eq:8} yeilds 
\begin{align}
